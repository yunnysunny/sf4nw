...
var serverRes = http.ServerResponse;
//var originalPrototype = serverRes.prototype;
/**
 * 加载视图
...
serverRes.prototype.loadView = function(viewName, params) {
    resource.loadTpl(this,viewName,params);
}
...
//serverRes.prototype.end = function() {
//    originalPrototype.apply(this,arguments);
//}
...
serverRes.prototype.hasSent = function() {
    return this._header;
}
